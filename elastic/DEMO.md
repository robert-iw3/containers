...
cosign verify --key https://artifacts.elastic.co/cosign.pub docker.elastic.co/elasticsearch/elasticsearch:9.4.3
cosign verify --key https://artifacts.elastic.co/cosign.pub docker.elastic.co/elasticsearch/elasticsearch-wolfi:9.4.3
cosign verify --key https://artifacts.elastic.co/cosign.pub docker.elastic.co/kibana/kibana-wolfi:9.4.3
cosign verify --key https://artifacts.elastic.co/cosign.pub docker.elastic.co/elastic-agent/elastic-agent-wolfi:9.4.3
```
